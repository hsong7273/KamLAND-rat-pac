#include <RAT/GeoTorusArrayFactory.hh>
#include <RAT/Log.hh>
...
namespace RAT {
    ...
    G4VPhysicalVolume *GeoTorusArrayFactory::Construct(DBLinkPtr table)
    {
	...
	G4VSolid* BaseSolid  = new G4Torus(volume_name, r_min, r_max, r_torus, phi_start, phi_delta);
