...
material: "Xe_scintillator_kamland",
color: [ 0.6, 0.3, 1.0, 0.2, ],
invisible: 0,
position: [0, 0, 0], //rot: null, 
}
...
rho_edge: [ 253.837, 256.1, 220.305, ],
z_origin: [ 0.0, 0.0, ],
pos_table: "PMTINFO_kamland_mask",
orientation: "point", 
orient_point: [0.0, 0.0, 0.0],
material: "acrylicBlack_kamland",
color: [ 0.6, 0.6, 0.7, 0.1, ],
...
//pos_table: "PMTINFO_17inch",
pos_table: "PMTINFO_kamland_ab",
start_idx: 0,
end_idx: 1324,
orientation: "point", 
orient_point: [0.0, 0.0, 0.0],
...
efficiency_correction: 1.027,  
add_concentrator: 1, // Flag: 0 = no concentrators, 1 = concentrators
//pos_table: "PMTINFO_outer_20inch",
pos_table: "PMTINFO_kamland_ab",
start_idx: 1879,
end_idx: 2103,
orientation: "manual", 
